...
function handleBrowseResult(resultData)
{
	...
	{
        var entry = '<div class="col-6 col-md-4 col-lg-3 col-xl-2 mb-2 d-flex justify-content-center"><button type="button" class="btn btn-danger">' + resultData[i] + '</button></div>';
